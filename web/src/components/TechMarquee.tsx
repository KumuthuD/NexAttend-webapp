...
/* ─────────────────────────────────────────────────────────────────────────────
   ...
   face-api.js & Google Gemini have no devicon → clean inline SVGs instead
──────────────────────────────────────────────────────────────────────────────── */
...
/* ─── Card — icon on top, name below ─────────────────────────────────────── */
/*
   Target: 6 cards visible at once across a ~1300 px viewport.
   Card width = 1300 / 6 ≈ 216 px → use 200px + mx-2 (8px each side = 16px gap)
   Total per card slot = 216px → 6 × 216 = 1296px ✓
*/
const CARD_W  = 200; // px
const ICON_SZ = 96;  // px — large enough to be clearly brand-identifiable
...
const TechMarquee: React.FC = () => (
    ...
    >
        ...
        >
            {/*
              Items repeated 4× so the track is always wider than any viewport.
              The marqueeLeft animation translates by -50% of the track width.
              Because each set is identical in width, -50% lands exactly on the
              clone's start → perfectly seamless loop.
            */}
