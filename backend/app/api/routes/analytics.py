...
async def get_analytics_summary(
    ...
    """
    Get a summary of analytics data, with optional filters for classroom and date range.
    """
    ...
    # 2. Get Total Students & Classrooms (Filtered if needed)
    if classroom_id:
    ...
    # 3. Aggregation Pipeline for Sessions
    pipeline = []
    if match_filter:
    ...
    pipeline.extend([
        ...
        },
        {
            "$group": {
                ...
                # Flatten records array for confidence/status metrics
    ...
    # Calculate Confidence and Flagged Anomalies
    total_confidence = 0.0
    record_count = 0
    flagged_anomalies = 0

    # records were grouped into an array of arrays
