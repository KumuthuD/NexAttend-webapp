...
const ContactPage = () => (
    <div className="py-16 px-4 container mx-auto">
        ...
        <div className="max-w-5xl mx-auto bg-gray-900 rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row border border-gray-800">
            ...
            <div className="md:w-7/12 p-8 md:p-12 bg-[#1a1b2e]">
                ...
                <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
                    ...
                    <div>
                        <label htmlFor="message" className="block text-lg text-gray-300 mb-2">Comment or Message</label>
                        <textarea
                            name="message"
                            id="message"
                            rows={5}
                            placeholder="Give your comment or message"
                            className="w-full bg-gray-700/50 border border-gray-600 rounded-lg py-3 px-4 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-all resize-none"
                        ></textarea>
                    </div>
                    <div className="pt-4">
                        <button
                            type="submit"
                            className="w-full bg-gradient-to-r from-violet-600 to-pink-500 hover:from-violet-700 hover:to-pink-600 text-white font-bold py-4 px-6 rounded-full shadow-lg transform transition hover:scale-[1.02] active:scale-[0.98] text-xl"
                        >
                            Submit
                        </button>
                    </div>
        ...
        <div className="text-center mt-12 text-gray-400 text-lg">
            <p>You can contact us through Instagram, LinkedIn, or Email for any inquiries or collaborations.</p>
        </div>
    </div>
