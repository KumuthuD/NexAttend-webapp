...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description, index = 0 }) => (
    <div
        className={`group relative glass-card glass-card-hover rounded-2xl p-8 text-center transition-all duration-500 h-full tilt-card animate-fade-in-up stagger-${(index % 8) + 1}`}
    >
